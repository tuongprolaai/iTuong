  ...
  return (
    <div className="w-full bg-[#ebebeb] min-h-screen pt-[15px] text-[#333]">
      <div className="container mx-auto px-4">
        {/* Breadcrumb */}
        <div className="flex items-center gap-2 text-[13px] mb-[30px]">
        ...
        <h1 className="text-center text-[28px] font-bold capitalize mb-[30px]">
          {displayTitle}
        </h1>
        ...
        <div className="mt-8 mb-[20px]">
          <h2 className="text-[14px] font-bold mb-[15px]">
            Danh mục: <span className="capitalize">{displayTitle}</span>
          </h2>
        ...
        <div className="flex justify-center mb-[60px]">
          <div className="flex items-center gap-2">
            <span className="bg-white px-3 py-1 rounded-full text-[13px] shadow-sm">
              Trang 1 of 6
            </span>

            <button className="w-8 h-8 rounded-full bg-[#8cc63f] text-white">
              1
            </button>

            <button className="w-8 h-8 rounded-full bg-white shadow-sm">
              2
            </button>
            ...
            {isExpanded && (
              <div className="flex justify-center mt-4">
                <button
                  ...
                  className="px-6 py-2 border rounded bg-white text-[14px]"
                >
                  Thu gọn <FontAwesomeIcon icon={faChevronUp} />
                </button>
              </div>
            )}
          </div>
