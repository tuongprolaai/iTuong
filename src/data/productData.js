...
export const bannerData = [
    { image: banner, link: "/macbook-air-m4", title: "MacBook Air M4" },
    { image: banner, link: "/macbook-air-m4", title: "MacBook Air M4" },
];
...
export const macbookAirProducts = [
    {
...
export const imacTags = ["iMac", "Mac mini", "Mac Studio", "Mac Pro"];
...
export const midBanners = [
    { image: banner, link: "/khuyen-mai/macbook-pro" },
    { image: banner1, link: "/khuyen-mai/mac-mini" },
    { image: banner2, link: "/khuyen-mai/macbook-air" },
];

export const macbookProTags = [
    "MacBook Pro M5",
    "MacBook Pro M4",
    "MacBook Pro M3",
    "MacBook Pro M2",
...
export const macbookProProducts = [
    {
    ...
    },
    {
        ...
        specs: "Apple M1 PRO 8-Core CPU 14-Core GPU 16GB RAM 512GB SSD - Like New",
        price: "27.000.000đ",
        image: macair,
        badge: "BÁN CHẠY",
    ...
    },
    {
        ...
        specs: "Apple M1 PRO 10-Core CPU 16-core GPU 16GB RAM 512GB SSD - Like New",
        price: "27.500.000đ",
        image: macair,
